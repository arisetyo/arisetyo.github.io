import{V as c,s as w,a as d,S as g,P as p,W as S,b as x,c as y,M as U,C as P}from"./anime.es-CHPHoHaE.js";import{E as M,R as A,S as l,a as T}from"./RGBShiftShader-UoLBgeHZ.js";import{O as b}from"./OutputPass-BVtf50tg.js";import"./transitions-B-yrgjAn.js";import"./cursor-CVGXRmtk.js";const E=`
  varying vec2 vUv;
  uniform float uTime;
...
`,z={uTime:{value:0},uAmplitude:{value:0},uMouse:{type:"v2",value:new c}},n={vertexShader:E,fragmentShader:W,uniforms:z},C={name:"DotScreenShader",uniforms:{tDiffuse:{value:null},tSize:{value:new c(256,256)},center:{value:new c(.5,.5)},angle:{value:1.57},scale:{value:1}},vertexShader:`
